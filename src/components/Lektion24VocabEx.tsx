...
export default function Lektion24VocabEx({ playAudio, playingId }: Props) {
  ...
  return (
    <div className="space-y-8 animate-fade-in max-w-4xl mx-auto">
      <div className="text-center space-y-4 mb-6">
        <h2 className="text-3xl font-black text-theme-dark uppercase tracking-tight">Luyện Tập Từ Vựng Lektion 24</h2>
