...
export default function Lektion5VocabEx({ playAudio, playingId }: Props) {
  ...
  const exercises = [
    {
      id: 'ex1',
      title: 'Bài 1. Điền từ phù hợp (Tourismus)',
      hint: 'Từ gợi ý: Reiseführer - besichtigen - Trinkgeld - Unterkunft',
      type: 'fill',
      data: [
        { id: '1', text: 'Wir möchten heute den Kölner Dom {1}.', answers: ['besichtigen'], altAnswers: [['besichtigen']] },
        { id: '2', text: 'Der {1} zeigt uns die Stadt.', answers: ['Reiseführer'], altAnswers: [['reiseführer']] },
        { id: '3', text: 'Wir haben leider noch keine {1} für die Nacht.', answers: ['Unterkunft'], altAnswers: [['unterkunft']] },
        { id: '4', text: 'Das Essen war super, geben wir dem Kellner {1}.', answers: ['Trinkgeld'], altAnswers: [['trinkgeld']] }
      ]
    },
    {
      id: 'ex2',
      title: 'Bài 2. Dịch từ vựng',
      hint: 'Gõ từ vựng tiếng Đức tương ứng.',
      type: 'match',
      data: [
        { id: '1', question: 'nhiều màu sắc:', answer: 'bunt', altAnswers: ['bunt'] },
        { id: '2', question: 'danh lam thắng cảnh:', answer: 'die Sehenswürdigkeit', altAnswers: ['sehenswürdigkeit', 'die sehenswürdigkeit'] },
        { id: '3', question: 'phản đối (việc gì):', answer: 'dagegen sein', altAnswers: ['dagegen sein', 'dagegen'] },
        { id: '4', question: 'nổi tiếng:', answer: 'berühmt', altAnswers: ['berühmt'] },
        { id: '5', question: 'ấn tượng:', answer: 'beeindruckend', altAnswers: ['beeindruckend'] }
      ]
    }
  ];
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto pb-12">
      <div className="text-center mb-8">
         <h2 className="text-3xl font-black text-orange-500 mb-2">Bài tập Từ vựng - Lektion 5</h2>
         <p className="text-theme-dark/60 font-medium">Luyện tập từ vựng chủ đề "Schaut mal, der schöne Dom!"</p>
      </div>
