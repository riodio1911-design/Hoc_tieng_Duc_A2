...
import { ChevronRight, ChevronLeft, Play, CheckCircle2, ShoppingCart, Info, ListChecks, BookOpen } from 'lucide-react';
        ...
        return (
          <div className="space-y-6 flex flex-col h-full max-w-5xl mx-auto py-4">
            <div className="text-center space-y-2 mb-4">
              <h2 className="text-4xl font-display font-black text-theme-dark uppercase tracking-wide">Bản Đồ Lộ Trình Lektion 4</h2>
